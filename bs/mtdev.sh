#!/bin/bash
upstream="https://github.com/rydberg/mtdev"
description="library for multitouch protocol translation",
dependencies=("glibc")

NAME="mtdev"
VERSION="1.1.7"
URL="https://bitmath.org/code/mtdev/mtdev-1.1.7.tar.bz2"
HASH="483ed7fdf7c1e7b7375c05a62848cce7"
HASH_TYPE="md5"
...
remove() {
  ...
  if t-installcheck "$NAME"; then
    rm -v /usr/bin/mtdev-test
    rm -v /usr/lib/libmtdev.so*
    rm -v /usr/lib/libmtdev.la
